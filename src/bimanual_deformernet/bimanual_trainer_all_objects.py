...
from dataset_loader_bimanual import BimanualDeformernetDataset
...
if __name__ == "__main__":
    ...
    dataset = BimanualDeformernetDataset(dataset_path, object_names, use_mp_input)
    ...
    model = DeformerNetBimanual(normal_channel=False, use_mp_input=use_mp_input).to(
        device
    )
