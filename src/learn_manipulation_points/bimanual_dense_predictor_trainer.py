...
from dense_predictor_architecture import DensePredictor
from dataset_loader_mani_point import DensePredictorAllObjectsDataset
...
def test(model, device, test_loader, epoch):
    ...
    with torch.no_grad():
        for sample in test_loader:
            ...
            pred = output[:, :2, :].argmax(dim=1, keepdim=True).squeeze()
...
if __name__ == "__main__":
    ...
    dataset = DensePredictorAllObjectsDataset(dataset_path, object_names)
